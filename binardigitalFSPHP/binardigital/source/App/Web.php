...
class Web extends Controller
{
    ...
    {
        $head = $this->seo->render(
            "Descubra " . CONF_SITE_NAME . " - " . CONF_SITE_DESC,
            CONF_SITE_DESC,
            url("/sobre"),
            theme("/assets/images/share.jpg")
        );
    ...
    public function blog(?array $data): void
    {
        $head = $this->seo->render(
            "Blog - " . CONF_SITE_NAME,
            "Confira em nosso blog dicas e sacadas sobre desenvolvimento de sistemas web e marketing digital.",
            url("/blog"),
            theme("/assets/images/share.jpg")
        );
    ...
    public function register(?array $data): void
    {
        if (!empty($data['csrf'])) {
            ...
            if (in_array("", $data)) {
                $json['message'] = $this->message->info("Por favor, prencha o campo.")->render();
                echo json_encode($json);
                return;
            }
        ...
        $head = $this->seo->render(
            "Fale com um consultor - " . CONF_SITE_NAME,
            CONF_SITE_DESC,
            url("/contato"),
            theme("/assets/images/share.jpg")
        );
